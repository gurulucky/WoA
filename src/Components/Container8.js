      ...
      <div className="row">
        ...
        <div className='col-6'>
          <div className="col- minting">
            <img className='container8-img' width='80%' src={cartoon} alt="" />
            <div className='nft'>
            ...
            </div>
            {
              initWeb3 ?
                <>
                  <button disabled={minting} onClick={conMetamask} >
                    Mint
                  </button>
                  {
                ...
                :
                <>
                  <h4 style={{ textAlign: 'center', margin: '0px', marginTop: '10px', marginBottom:'10px', color: 'yellow', display: 'flex', alignItems: 'center', justifyContent: 'space-around' }}>
                    {
